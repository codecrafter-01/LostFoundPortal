  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotification({
        ...
        message: response.data.message || "Lost report submitted! Confirmation email has been sent to your student inbox.",
        type: "success",
        isEmail: true,
      });
      ...
      showNotification({
        ...
        message: error.response?.data?.message || "Failed to submit lost report.",
        type: "error",
      });
    }
  };
